...
export default function Histoire() {
  const civilisations = [
    ...
    },
    {
      ...
      symbole: 'Cunéiforme babylonien (◄▼ = 11)',
      description: 'Entre le Tigre et l\'Euphrate naquit la première civilisation urbaine. Les Sumériens et Babyloniens inventèrent l\'écriture cunéiforme, la roue et le premier code juridique — celui de Hammurabi. Leur système sexagésimal (base 60) nous a légué les 60 secondes d\'une minute, les 60 minutes d\'une heure et les 360 degrés d\'un cercle. Le nombre 11 (◄▼) combine le chevron de dizaine (◄) et le clou vertical d\'unité (▼).',
