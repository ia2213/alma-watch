        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          {prev ? (
            <Link href={`/collection/${prev.id}`} className="group flex items-center gap-6">
              <span className="nav-link group-hover:text-amber-200 transition-colors" style={{color: 'var(--text-muted)'}}>← Précédent</span>
              <div>
          ...
          {next ? (
            <Link href={`/collection/${next.id}`} className="group flex items-center gap-6 text-right">
              ...
              <span className="nav-link group-hover:text-amber-200 transition-colors" style={{color: 'var(--text-muted)'}}>Suivant →</span>
            </Link>
          ) : <div />}
        </div>
      </section>
