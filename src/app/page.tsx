...
export default function Home() {
  return (
    <>
      {/* HERO — padding-top pour compenser la navbar fixée (~90px) */}
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden" style={{paddingTop: '90px'}}>
        {/* Image de fond */}
        <div
        ...
        <div className="absolute bottom-0 left-0 right-0 h-48" style={{background: 'linear-gradient(to bottom, transparent, white)'}} />
        ...
        <div className="relative z-10 text-center px-6 space-y-8">
          ...
          <h1 className="font-serif leading-none tracking-[0.1em] gold-gradient" style={{fontSize: 'clamp(5rem, 12vw, 11rem)'}}>
            ALMA
          </h1>
      ...
      <footer className="border-t py-14 px-6 bg-white" style={{borderColor: 'rgba(0,0,0,0.07)'}}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="font-serif text-2xl tracking-[0.3em] gold-gradient">ALMA</div>
